            ...
            <div className="container px-6 py-12 mx-auto lg:py-20">
                <div className="lg:flex lg:items-center">
                    ...
                    <div className="lg:w-1/2">
                        <h1 className="fancy-font text-8xl text-white mb-24">My Diary</h1>
                        <h2 className="mt-6 text-lg opacity-70">Your memories. Your travels. Private and Safe.</h2>
                    ...
                    <div className="mt-10 lg:w-1/2 lg:mt-0">
                        <form onSubmit={handleSubmit} className="w-full lg:max-w-xl space-y-6">
                            ...
                            <div className="relative">
                                ...
                                >
                                    {showConfirmPassword ? <EyeOff className="w-5 h-5 opacity-60"/> : <Eye className="w-5 h-5 opacity-60"/>}
                                </button>
                            </div>
                            ...
                            <div className="flex flex-col md:flex-row md:items-center gap-4 pt-2">
                                ...
                                <Link to="/login" className="text-blue-500 hover:underline text-center">
                                    Already Have One?
                                </Link>
                            </div>
